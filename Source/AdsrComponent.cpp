...
AdsrComponent::AdsrComponent(juce::String name, juce::AudioProcessorValueTreeState& valueTree, juce::String attackId, juce::String decayId, juce::String sustainId, juce::String releaseId)
{
    ...
    setSliderWithLabel(attackSlider, attackLabel, valueTree, attackId, attackAttachment);
    setSliderWithLabel(decaySlider, decayLabel, valueTree, decayId, decayAttachment);
    setSliderWithLabel(sustainSlider, sustainLabel, valueTree, sustainId, sustainAttachment);
    setSliderWithLabel(releaseSlider, releaseLabel, valueTree, releaseId, releaseAttachment);
